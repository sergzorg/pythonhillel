...
print('task 4.2  :  ',[sorted(set(mas))[len(sorted(set(mas)))-1], sorted(set(mas))[len(sorted(set(mas)))-2], sorted(set(mas))[len(sorted(set(mas)))-3]],"  three unique maximal numbers")
